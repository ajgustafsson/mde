...
public abstract class NodeImpl extends MinimalEObjectImpl.Container implements Node {
	...
	public PetriNet getNet() {
		if (net != null && net.eIsProxy()) {
			...
			if (net != oldNet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PetrinetPackage.NODE__NET, oldNet, net));
			}
		}
		return net;
	}
	...
	public void setNet(PetriNet newNet) {
		...
		net = newNet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.NODE__NET, oldNet, net));
	}
	...
	public EList<Arc> getIncoming() {
		if (incoming == null) {
			incoming = new EObjectResolvingEList<Arc>(Arc.class, this, PetrinetPackage.NODE__INCOMING);
		}
		return incoming;
	}
	...
	public EList<Arc> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectResolvingEList<Arc>(Arc.class, this, PetrinetPackage.NODE__OUTGOING);
		}
		return outgoing;
	}
