...
public class EngineAdapterFactory extends AdapterFactoryImpl {
	...
	protected EngineSwitch<Adapter> modelSwitch =
		new EngineSwitch<Adapter>() {
			...
			@Override
			public Adapter caseResultTask(ResultTask object) {
				return createResultTaskAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link Engine.ResultTask <em>Result Task</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createResultTaskAdapter() {
		return null;
	}
